 ...
 *     description: Only authorized users can retrieve products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Only authorized users can retrieve a product by id.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               description: Updated smartphone with better battery life
 *               price: 1099.99
 *               stock: 18
 *               category: electronics
 *     responses:
